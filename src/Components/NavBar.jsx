...
import SpotifyData from "../Data/SpotifyData.js"
...
export default function NavBar() {
  ...
  return (
    <nav className='hidden md:flex lg:flex w-full  justify-between h-[10vh] px-12 text-white'>
      <div className='flex items-center gap-3'>
      <AiOutlineSpotify  className='text-green-500 size-10' />

        <div className='flex gap-2'>
          <FaChevronLeft className='size-7 font-light cursor-pointer text-gray-400 active:text-white' />
         ...
         <Link to={'/home'}> <div className='w-12 h-12 bg-[#202020] cursor-pointer flex items-center justify-center rounded-[50%]  hover:bg-gray-800  '>
          ...
          '>
            ...
            <label className='flex gap-1'>
              <BiSearch className='size-7  cursor-pointer'/>
              <input className='outline-0   text-[1.2rem] w-90'
                type='text' placeholder='What do you want to play?' />
            </label>

            <div className='flex gap-2  items-center'>
              <p className=' text-2xl'> |</p>
              <FaFolder className='size-5 cursor-pointer' />
            </div>
          </div>
    ...
    {/* Right Section */}
      <div className='flex gap-5   items-center'>
        ...
        <div className='flex flex-col bg-white w-[1px]'>
          ...
          <MdGroups2  className='size-7'/>
        </div>
        <div className='w-12 h-12 rounded-[50%] cursor-pointer bg-[#202020] overflow-hidden 
         hover:border-4
